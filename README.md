...
#### Visual trimmer (`/editor`)
The **✂ Trim a video** link (top of the page, or `http://127.0.0.1:8000/editor`)
opens a hand-trimming view: pick a downloaded video from the dropdown — or paste
a URL/path to fetch one into `media/` — and it loads on a **timeline with a
